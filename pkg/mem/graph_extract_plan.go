...
Extract every distinct, directly supported definition, claim, procedure, example, formula, constraint,
comparison, and topic that is useful for later navigation. Do not omit an evidence item merely because
another item is more relevant to the focus. Concision means avoiding duplicates, not skipping supported facts.`
