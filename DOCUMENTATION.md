...
**Дата:** 2026-08-21 (сохраняемая раскладка knowledge map)
...
LLM-извлечение доступны через CLI; автономный HTML и live loopback-представление
дают визуальный интерфейс, но изменяющие действия пока остаются CLI-операциями.
